...
export default function LoginPage() {
    ...
    return (
        <div className="h-screen w-screen flex bg-background font-figtree text-[13px] overflow-hidden transition-colors duration-300">
            ...
            {/* Hero Side */}
            <div className="hidden lg:flex flex-1 bg-pace-bg-subtle items-center justify-center p-20 relative overflow-hidden">
                {/* Grid Pattern */}
                ...
                <div className="max-w-md relative z-10">
                    ...
                    <h4 className="text-[32px] font-bold text-admin-value leading-[1.1] tracking-tighter mb-6 uppercase">
