...
function PrepaidVouchersContent() {
    ...
    const handleCreateVouchers = async () => {
        ...
        try {
            ...
            setFormData({ router_name: '', plan: '', count: 1 });
            setPlans([]);
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <button
                                                    ...
                                                    className="h-8 w-8 flex items-center justify-center text-gray-300 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all border border-transparent hover:border-red-100"
                                                >
                                                    <Trash2 size={14} />
                                                </button>
                                            </td>
            ...
            >
                <div className="space-y-4 py-2">
                    <div className="space-y-1.5">
                        ...
                        <select
                            className={cn(
                                "w-full px-3 py-2.5 rounded-xl border border-pace-border bg-pace-bg-subtle outline-none focus:bg-card-bg focus:ring-2 focus:ring-pace-purple/5 focus:border-pace-purple text-[13px] font-bold transition-all appearance-none cursor-pointer text-admin-value",
                                activeRouterId !== 'all' && "cursor-not-allowed opacity-70"
                            )}
