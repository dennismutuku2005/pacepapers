            ...
            >
                <form onSubmit={handleSubmit} className="space-y-4 pt-2">
                    ...
                    <button
                        ...
                        className="w-full py-3 bg-pace-purple text-white rounded-xl font-medium text-[11px] uppercase tracking-widest hover:bg-[#3d1a75] transition-all active:scale-95 disabled:opacity-50 mt-4"
                    >
